...
os.chdir('C:/PY_working/PYRDM')

S1 = pd.read_excel('./inputs/inputs/RCP0.xlsm')
S2 = pd.read_excel('./inputs/inputs/RCP45.xlsm')
S3 = pd.read_excel('./inputs/inputs/RCP85.xlsm')
S4 = pd.read_excel('./inputs/inputs/RCP45def.xlsm')
S5 = pd.read_excel('./inputs/inputs/RCP85def.xlsm')
S6 = pd.read_excel('./inputs/inputs/RCP45bonds.xlsm')
S7 = pd.read_excel('./inputs/inputs/RCP45rates.xlsm')
S8 = pd.read_excel('./inputs/inputs/RCP85bonds.xlsm')
S9 = pd.read_excel('./inputs/inputs/RCP85rates.xlsm')
...
#############################################################################
RCP0_B = pd.read_csv('./outputs/outputs/S_0.csv')
RCP45_B = pd.read_csv('./outputs/outputs/S_1.csv')
RCP85_B = pd.read_csv('./outputs/outputs/S_2.csv')
RCP45_def = pd.read_csv('./outputs/outputs/S_3.csv')
RCP85_def = pd.read_csv('./outputs/outputs/S_4.csv')
RCP45_bonds = pd.read_csv('./outputs/outputs/S_5.csv')
RCP45_rates = pd.read_csv('./outputs/outputs/S_6.csv')
RCP85_bonds = pd.read_csv('./outputs/outputs/S_7.csv')
RCP85_rates = pd.read_csv('./outputs/outputs/S_8.csv')
#Delete index column:
a = RCP0_B.values
